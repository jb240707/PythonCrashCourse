...
#Pop names one at a time and then write a message to the guests being removed from the list to apologize and remember the list shrinks each time a name is popped.
...
#Print a message indicating how many guests are invited to dinner, or the length of the list. 
print(len(guests))
